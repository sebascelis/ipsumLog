...
urlpatterns = [
    ...
    path('user/form/<int:pk>/',    views.FormDetailView.as_view()),
    path('forms/all',              views.FormsView.as_view()),
    path('user/form/<int:pk>/update', views.FormUpdateView.as_view())
]
